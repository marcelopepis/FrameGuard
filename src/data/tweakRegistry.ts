...
export const TWEAK_REGISTRY: readonly TweakRegistryEntry[] = [
  ...
  {
    id: 'disable_windows_recall',
    name: 'Desabilitar Windows Recall',
    description: 'Desativa o recurso de IA que tira screenshots contínuos da sua tela. Preventivo mesmo sem hardware Copilot+.',
    categoryKey: 'privacy',
    infoCommand: 'get_recall_info',
    applyCommand: 'disable_windows_recall',
    revertCommand: 'revert_windows_recall',
  },
  {
    id: 'disable_wer',
    name: 'Desabilitar Relatório de Erros do Windows',
    description: 'Impede o envio automático de relatórios de crash para a Microsoft.',
    categoryKey: 'privacy',
    infoCommand: 'get_wer_info',
    applyCommand: 'disable_wer',
    revertCommand: 'revert_wer',
  },
  {
    id: 'disable_activity_history',
    name: 'Desabilitar Histórico de Atividades',
    description: 'Para o Windows de registrar e sincronizar sua atividade (Timeline). Nenhum dado de uso é coletado ou enviado.',
    categoryKey: 'privacy',
    infoCommand: 'get_activity_history_info',
    applyCommand: 'disable_activity_history',
    revertCommand: 'revert_activity_history',
  },
  {
    id: 'disable_location_tracking',
    name: 'Desabilitar Rastreamento de Localização',
    description: 'Bloqueia o acesso à localização geográfica para todos os apps do Windows.',
    categoryKey: 'privacy',
    infoCommand: 'get_location_tracking_info',
    applyCommand: 'disable_location_tracking',
    revertCommand: 'revert_location_tracking',
  },
  {
    id: 'disable_feedback_requests',
    name: 'Desabilitar Solicitações de Feedback',
    description: "Remove os popups 'Como está sendo sua experiência?' do Windows.",
    categoryKey: 'privacy',
    infoCommand: 'get_feedback_requests_info',
    applyCommand: 'disable_feedback_requests',
    revertCommand: 'revert_feedback_requests',
  },
  {
    id: 'edge_debloat',
    name: 'Edge Debloat',
    description: 'Desabilita comportamentos agressivos do Microsoft Edge: startup boost, execução em background, sidebar Copilot, shopping assistant e telemetria.',
    categoryKey: 'privacy',
    infoCommand: 'get_edge_debloat_info',
    applyCommand: 'apply_edge_debloat',
    revertCommand: 'revert_edge_debloat',
  },

  // ── Visual e Experiência (adicional) ──────────────────────────────────────
  {
    id: 'classic_right_click',
    name: 'Menu de Contexto Clássico',
    description: "Restaura o menu de contexto completo do Windows 10 no Windows 11. Elimina o 'Mostrar mais opções'.",
    categoryKey: 'visual',
    infoCommand: 'get_classic_right_click_info',
    applyCommand: 'apply_classic_right_click',
    revertCommand: 'revert_classic_right_click',
  },
