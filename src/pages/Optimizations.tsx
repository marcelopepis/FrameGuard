...
export default function Optimizations() {
  ...
  return (
    <div className={styles.page}>
      ...
      {/* ── CTA para página Aprenda ── */}
      <div className={styles.learnCta} onClick={() => navigate('/learn')}>
        <BookOpen size={18} strokeWidth={2} className={styles.learnCtaIcon} />
        <div>
          <p className={styles.learnCtaTitle}>Não encontrou alguma otimização aqui?</p>
          <p className={styles.learnCtaText}>
            Visite a página <strong>Aprenda</strong> para descobrir se essa otimização é realmente
            válida — ou apenas mais um mito da internet.
          </p>
        </div>
      </div>
    </div>
